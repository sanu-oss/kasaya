...
app.addCommand({
  command: 'open $url',
  help:
    'open "google.com" - Navigates to google.com in the current browser window',
  handler: open.bind(null, state, { isNewTab: false })
});
app.addCommand({
  command: 'open $url in new window',
  help:
    'open "google.com" in new window - Navigates to google.com in a new browser window',
...
app.addCommand({
  ...
  aliases: [],
  help:
    'read "https://www.facebook.com/${profile}" from url - Extracts profile name to a variable from a given url',
...
app.addCommand({
  ...
  aliases: [],
  help:
    'read "Leave this site without ${action} from alert - Extracts content from browser alert and saves to a variable',
...
app.addCommand({
  ...
  aliases: [],
  help:
    'read "checkout ${product}" 0 - Extracts the product name of the first item with matching pattern',
  handler: read.readByTemplate.bind(null, state)
});
app.addCommand({
  ...
  aliases: [],
  help:
    'read "John is ${age} years old" near "biography" - Specify a match to read near to a target in case of multiple matches',
  handler: read.readByTemplate.bind(null, state)
});
app.addCommand({
  ...
  aliases: [],
  help:
    'read "Facebook ${title}" from page title - Extracts "Login" as page title',
...
app.addCommand({
  ...
  aliases: [],
  help:
    'read "${ratings}" to the "right" of "IMDb" - Extracts rating to the right of text "IMDb"',
  handler: read.readByTemplate.bind(null, state)
});
app.addCommand({
  ...
  help:
    'read ${employeeNo} from row "John" column "Employee No" - Extracts "Employee No" of "John" in a table',
  handler: read.readByTemplate.bind(null, state)
});
app.addCommand({
...
app.addCommand({
  ...
  help:
    'press "enter" - Issues key strokes such as "enter", "tab", "shift", "delete"',
...
app.addCommand({
  ...
  help:
    'check if "checkbox" is checked - Checks whether an input element is checked',
...
app.addCommand({
  ...
  help:
    'check if "Login" is enabled - Checks whether the "Login" button is clickable',
...
app.addCommand({
  ...
  help:
    'check if "Out of Stock" is available - Checks if "Out of Stock" is within current window',
...
app.addCommand({
  ...
  help:
    'check if "Out of Stock" is not available - Checks if "Out of Stock" is not displayed within current window',
  handler: assert.checkElementAvailability.bind(null, state, {
    isAvailable: false
  })
});
app.addCommand({
  ...
  help:
    'check if $age is "25" - Checks whether a given value is equal to a previously saved value',
  handler: assert.common
});
app.addCommand({
  command: 'check if $actualVal is not $notExpectedVal',
  help:
    'check if $age is not "25" - Checks whether a given value is not equal to a previously saved value',
  handler: assert.common
});
app.addCommand({
...
app.addCommand({
  ...
  help:
    'click "Purchase" 0 - Clicks on the first occurrence of "Purchase" button as specified with index "0" in case of multiple matches',
  handler: click.bind(null, state, { click: true })
});
app.addCommand({
  command: 'click $selector near $marker',
  help:
    'click "Purchase" near "Shoes" - Clicks on "Purchase" button near "Shoes" text in case of multiple matches for "Purchase"',
  handler: click.bind(null, state, { click: true })
});
app.addCommand({
...
app.addCommand({
  ...
  help:
    'click on row "John" column "Employee No" - Clicks on cell with "Employee No" of "John" in a table',
  handler: click.bind(null, state, { click: true })
});
app.addCommand({
  command:
...
app.addCommand({
  ...
  help:
    'hover "chat icon" 0 - Hovers over the first "chat icon" as specified with index "0" in case of multiple chat icons',
  handler: click.bind(null, state, { hover: true })
});
app.addCommand({
  command: 'hover $selector near $marker',
  help:
    'hover "chat icon" near "John Doe" - Hovers over "chat icon" near text "John Doe" in case of multiple chat icons',
  handler: click.bind(null, state, { hover: true })
});
app.addCommand({
...
(async () => {
  ...
  const { mode, extension, headless, env } = argv;
  ...
  await launch(state, {
    args: { browserName: 'chrome', extension, isHeadless: headless }
  });
  let res;
  try {
