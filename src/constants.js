...
const CLOSE_ERR =
  'Incorrect usage. "close" command currently supports "window" or "tab" as parameters!';
const CLEAR_ERR =
  'Incorrect usage of command. Accepted parameters are, "text", "input" or "highlights"!';
const BROWSER_DETACHED_ERR =
  'Browser window is detached and could not be closed. Please close it manually. Exiting Kasāya!';
const NAVIGATION_ERR =
  'Unrecognized parameter. "go" command supports only back/forward as parameters!';
const NO_VARIABLE_FOUND = 'No such a variable!';
const INSPECT_ERR =
  'Something went wrong while identifying your element. Please try again!';
const BROWSER_LAUNCH_ERR = 'Could not launch browser!';
const VARIABLE_FORMAT_ERR = 'Variable name should start with a "$"!';
const EVALUATE_UNEXPECTED_ERR =
...
const URL_READ_ERR =
  'Requested parameters could not be extracted from the browser url!';
const TITLE_READ_ERR =
  'Requested parameters could not be extracted from the page title!';
const ALERT_READ_ERR =
  'Requested parameters could not be extracted from the current alert dialog box!';
const BROWSER_LOAD_ERR = 'Browser load operation timed out!';
const SWITCH_ERR =
  'Incorrect usage. "switch" command currently supports "window" or "tab" as parameters!';
const ACTIVE_ELEMENT_ERR =
  'Currently active element does not accept text input!';
const TIME_UNIT_ERR =
  'Incorrect value for time, please enter the time in seconds!';
...
const BROWSER_EXECUTE_FUNC_ERR =
  'Something went wrong while executing the browser function!';
